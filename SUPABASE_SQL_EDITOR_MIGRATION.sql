-- SUPPRIVA FINAL SQL EDITOR MIGRATION PACKAGE
-- Execute this complete script once inside the Supabase SQL Editor.
-- Scope: core schema, categories CRUD compatibility, indexes, triggers, RLS enablement.
-- Note: final production RLS policies are intentionally not included.
...
-- Run this full package, then inspect the result grids from these selects.
