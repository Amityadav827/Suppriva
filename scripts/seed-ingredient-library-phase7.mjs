...
const INGREDIENTS = [
  { name: "Orange Peel Extract", slug: "orange-peel-extract", category: "Fruits & Botanicals" },
  { name: "Lemongrass", slug: "lemongrass", category: "Herbal Extracts" },
  { name: "Lemongrass Oil", slug: "lemongrass-oil", category: "Oils" },
  { name: "Lavender Oil", slug: "lavender-oil", category: "Oils" },
  { name: "Flaxseed Oil", slug: "flaxseed-oil", category: "Oils" },
  { name: "Almond Oil", slug: "almond-oil", category: "Oils" },
  { name: "Tea Tree Oil", slug: "tea-tree-oil", category: "Oils" },
  { name: "Undecylenic Acid", slug: "undecylenic-acid", category: "Specialty Ingredients" },
  { name: "Neem", slug: "neem", category: "Herbal Extracts" },
  { name: "Soursop", slug: "soursop", category: "Fruits & Botanicals" },
  { name: "Tamarind", slug: "tamarind", category: "Fruits & Botanicals" },
  { name: "Purple Carrot Powder", slug: "purple-carrot-powder", category: "Antioxidants" },
  { name: "Vitamin B6", slug: "vitamin-b6", category: "Vitamins" },
  { name: "Niacin", slug: "niacin", category: "Vitamins" },
  { name: "Manganese", slug: "manganese", category: "Minerals" },
  { name: "Baicalein", slug: "baicalein", category: "Antioxidants" },
  { name: "Hesperidin Methyl Chalcone", slug: "hesperidin-methyl-chalcone", category: "Antioxidants" },
  { name: "Lactobacillus Plantarum", slug: "lactobacillus-plantarum", category: "Probiotics" },
  { name: "Lactobacillus Salivarius", slug: "lactobacillus-salivarius", category: "Probiotics" },
  { name: "Lactobacillus Rhamnosus", slug: "lactobacillus-rhamnosus", category: "Probiotics" },
];
...
async function main() {
  ...
  console.log(
    JSON.stringify(
      {
        phase: "Ingredient Library Expansion Phase 7",
