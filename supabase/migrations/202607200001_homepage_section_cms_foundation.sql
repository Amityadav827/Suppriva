-- SUPPRIVA HOMEPAGE SECTION CMS FOUNDATION
-- Phase 1 configuration layer for section visibility, order, copy, and CTA defaults.
...
set
  ...
  subtitle = coalesce(public.homepage_sections.subtitle, excluded.subtitle),
  cta_label = coalesce(public.homepage_sections.cta_label, excluded.cta_label),
  cta_url = coalesce(public.homepage_sections.cta_url, excluded.cta_url),
  updated_at = now();
