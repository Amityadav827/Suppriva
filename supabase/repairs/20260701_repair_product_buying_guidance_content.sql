-- SUPPRIVA PRODUCT BUYING GUIDANCE CONTENT REPAIR
-- Safe to run multiple times.
-- Repairs production environments where the Where To Buy rich text column
-- has not been applied or PostgREST schema cache is stale.
...
--   and column_name = 'buying_guidance_content';
