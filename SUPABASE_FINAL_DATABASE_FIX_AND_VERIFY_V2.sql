-- SUPPRIVA FINAL DATABASE FIX AND VERIFICATION PACKAGE V2
...
-- 4. V2 safety: never update generated columns or Supabase-managed auth fields.
...
drop trigger if exists set_seo_updated_at on public.seo;
