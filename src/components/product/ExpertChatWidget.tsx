...
export function ExpertChatWidget({
  ...
  return (
    <>
      <div className="fixed bottom-4 left-2 z-[60] md:bottom-6 md:left-6">
        <motion.button
          type="button"
          ...
          className="relative grid size-[48px] place-items-center rounded-full border border-white/70 bg-[linear-gradient(180deg,#0B603C_0%,#0A5535_55%,#08492E_100%)] text-white shadow-[0_14px_30px_rgba(11,93,59,0.24)] ring-[7px] ring-[#EDF6EF]/80 backdrop-blur-sm transition hover:shadow-[0_20px_40px_rgba(11,93,59,0.3)] md:size-[52px] md:ring-[8px]"
        >
          <span
            aria-hidden="true"
          ...
          />
          <MessageCircleMore className="relative z-10 size-[18px] md:size-5" />
        </motion.button>
      </div>
      ...
      <AnimatePresence>
        {isOpen ? (
          <motion.aside
            ...
            className="fixed bottom-[5.5rem] left-2 right-4 z-[70] max-h-[calc(100dvh-6.5rem)] overflow-hidden rounded-[28px] border border-black/6 bg-white shadow-[0_32px_90px_rgba(15,23,42,0.22)] sm:left-2 sm:right-auto sm:w-[calc(100vw-2rem)] sm:max-w-[392px] sm:origin-bottom-left md:bottom-[5.9rem] md:left-6 md:w-[384px] md:max-w-[384px] md:max-h-[78vh]"
            role="dialog"
            aria-label="Ask Our Supplement Expert"
          >
            <div className="flex max-h-[inherit] flex-col md:max-h-none">
              <div className="bg-[linear-gradient(180deg,#074A2F_0%,#0A5535_55%,#0B5D3B_100%)] px-4 py-2.5 text-white md:px-5 md:py-2.5">
                <div className="flex items-start justify-between gap-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="min-w-0">
                      <h2 className="font-heading text-[0.95rem] font-extrabold leading-tight md:text-[0.98rem]">
              ...
              <div className="min-h-0 flex-1 overflow-y-auto px-4 pb-6 pt-3 md:overflow-visible md:px-5 md:pb-6 md:pt-3">
                {isSuccess ? (
                  <motion.div
                  ...
                  <div className="space-y-2.5">
                    <div className="rounded-[20px] border border-primary/10 bg-soft-green/70 px-4 py-2 shadow-[0_14px_36px_rgba(15,23,42,0.04)]">
                      <p className="font-heading text-[0.9rem] font-bold text-text-dark">
                    ...
                    <form className="space-y-2.5" onSubmit={submitQuery}>
                          ...
                          <AnimatePresence>
                            {isQuestionTypeOpen ? (
                              <motion.div
                                ...
                                className="absolute left-0 right-0 top-[calc(100%+0.4rem)] z-20 overflow-hidden rounded-[18px] border border-border-light bg-white p-2 shadow-[0_22px_58px_rgba(15,23,42,0.14)]"
                              >
                      ...
                      >
                        <textarea
                          ...
                          className={`${inputClasses(Boolean(errors.message))} min-h-[92px] resize-none py-2.5 md:min-h-[90px]`}
                      ...
                      <motion.button
                        ...
                        className="inline-flex min-h-[50px] w-full items-center justify-center gap-2 rounded-pill bg-[linear-gradient(90deg,#0A5535_0%,#0B5D3B_55%,#0E7A4F_100%)] px-5 font-heading text-[0.94rem] font-semibold text-white shadow-[0_20px_54px_rgba(11,93,59,0.22)] transition hover:shadow-[0_26px_68px_rgba(11,93,59,0.28)] disabled:cursor-not-allowed disabled:opacity-75"
                      >
                        {isSubmitting ? (
                          <>
                      ...
                      <p className="px-3 pb-2 pt-0.5 text-center text-[12px] leading-5 text-muted/90">
