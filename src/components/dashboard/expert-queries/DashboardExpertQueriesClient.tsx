        ...
        <div className="flex flex-1 flex-col gap-3 md:flex-row">
          <div className="flex min-h-12 flex-1 items-center gap-3 rounded-pill border border-border-light bg-white px-4 shadow-[0_12px_30px_rgba(15,23,42,0.04)] md:max-w-md">
            ...
            <input
              ...
              placeholder="Search by name, email, category, or question..."
                ...
                <tr key={item.id} className="border-t border-border-light align-top">
                  ...
                  <td className="max-w-[220px] px-5 py-4">
                    <p className="font-heading font-semibold text-text-dark">
                      {item.category || item.product_name || "General question"}
                    </p>
                    <p className="mt-1 text-xs text-muted">{item.question_type}</p>
                    {item.product_name ? (
                  ...
                  <td className="max-w-[360px] px-5 py-4">
                    <p className="line-clamp-4 whitespace-pre-line text-sm leading-6 text-muted">
                      {item.message}
                    </p>
                  </td>
                  <td className="px-5 py-4">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <a
                        href={`mailto:${item.email}?subject=${encodeURIComponent(
                          "Suppriva Expert Guidance Follow-up",
                        )}`}
